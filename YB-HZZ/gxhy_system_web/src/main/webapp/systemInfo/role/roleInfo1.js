var role = {
	 ...
	 loadTable: function () {
	    ...
	    showModal:function(type){
	    	 setTimeout(function(){  
	    	    if(type==1){
	    	    	...
	    	    	$("#roleId").val(role.clickRow.roleId);
	    ...
	    submitForm:function(type){
	    	switch (type) {
			case 1:	case 2:
				formUtil.submitFormData(role,WEB_ROOT+"/system/role/addRole?type="+type+"");
				break;
			case 3:
...
$(function(){
	...
	$(".queryBtn_import").click(function(){
		 ...
		 formUtil.uploadFile("uploadRole",WEB_ROOT+"/system/role/importRoleFile?type=1",2);
