	...
	loadTable:function(){
		...
		bootstrapTable.columns = [{
            ...
            formatter: function (value, row, index) {
            	 var pageSize = $('#table_aRiverLong').bootstrapTable('getOptions').pageSize;//通过表的#id 可以得到每页多少条
	             var pageNumber = $('#table_aRiverLong').bootstrapTable('getOptions').pageNumber;//通过表的#id 可以得到当前第几页
