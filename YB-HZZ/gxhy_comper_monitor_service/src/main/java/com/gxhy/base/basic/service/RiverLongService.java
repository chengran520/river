...
import com.gxhy.base.basic.model.StBprpBModel;
...
public class RiverLongService extends BaseMapper{
  ...
  public List<ResultRiverInfoModel> getZlist(String stcd,String stm,String etm) {
	...
	public List<StBprpBModel> getStBprpBInfo() {
		Map<String, Object> map = new Hashtable<String, Object>();
		map.put(RequestModel.SQLID, RiverLongMapper.class.getName() + ".getStBprpBInfo");
